...
##### 1.2.3 influ_continuous() and influ_discrete: Trait Evolution Continous and Discrete Characters
...
n.sim=25, breaks=seq(.1,.3,.1), model = "SYM", transform = "none",
n.cores = 2,track = FALSE)
# Print summary statistics for the transitions rates, aic-values and (if applicable) 
# optimisation parameter
summary(samp_binary)
# Visual diagnostics
