...
#' If \code{ntree} and \code{nvari} are set to 1, the function computes a 
...
#' sp <- tree$tip.label
#' # variPgls analysis
#' variPgls(resp=Ly,pred=Lx$xmean,vari.pred=Lx$xse,tree,nvari=2,
...
#' nvari=2,method="normal",taxa.nam=sp)
#' }
#'  @export
