...
#' clade <- interaction_clade_tree_phyglm(y ~ x, phy = mphy, data = dat, times.tree = 3, times.clade = 5, clade.col = "cla")
...
interaction_clade_tree_phyglm <- function(formula, data, phy, clade.col, n.species = 5, 
  ...
  class(res) <- c("sensiClade_Tree","sensiClade_TreeL")
  ### Warnings:
