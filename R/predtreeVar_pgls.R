...
#' It picks n times (\code {npred}) a random value within an interval for the predictor variable and 
#' it repeats the analysis m times (\code {ntree}) for m trees in a multiPhylo file. 
...
#' @param se.pred A vector containing the standard error of \code{pred}  
