...
#' @param nintra Number of times to repeat the analysis generating a random value for the predictor variable.
...
intra_phyloglm <- function(formula,data,phy,
  ...
  res <- list(analysis.type="intra_phyloglm",formula=formula,
                 datas=full.data,
